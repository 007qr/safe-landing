...
const Speaker: Component<IconProps> = (props) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" class={cn(props.class)} width={props.width ?? "32"} height={props.height ?? "32"} viewBox="0 0 28 28">
            <path
                fill="currentColor"
