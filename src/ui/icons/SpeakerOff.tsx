...
const SpeakerOff: Component<IconProps> = (props) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" class={cn(props.class)} width={props.width ?? "1em"} height={props.height ?? "1em"} viewBox="0 0 28 28">
            <path
                fill="currentColor"
